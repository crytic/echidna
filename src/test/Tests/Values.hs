...
valuesTests = testGroup "Value extraction tests"
  [ 
    ...
    , testContract' "values/smallValues.sol" Nothing Nothing (Just "coverage/test.yaml") False False
    ...
    , testContract "values/rconstants.sol"   Nothing
      [ ("echidna_found failed",                   solved      "echidna_found") ]
    , testContract' "values/extreme.sol"   Nothing Nothing (Just "values/extreme.yaml") False False
    ...
    , testContract' "values/utf8.sol"   Nothing Nothing (Just "values/extreme.yaml") False False
      [ ("testNonUtf8 passed",                   solved      "testNonUTF8")]
    , testContract' "values/create.sol" (Just "C") Nothing Nothing True False
